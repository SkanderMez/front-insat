...
!function (e) {
  ...
  i.prototype = {
    init: function () {
      ...
      this.main_menu.find(".sf-mega > ul").each(function () {
        var t = e("<div></div>"), i = e('<div class="sf-mega-section-wrap" ></div>'), n = 0;
      ...
      if ("mobile-landscape" != t && "mobile-portrait" != t && "tablet" != t) {
        var i = e(".kingster-body-wrapper"), n = this.main_menu.find(".sf-menu > li.kingster-normal-menu .sub-menu");
        ...
        }), n.css({display: "none"}), this.main_menu.find(".sf-menu > li.kingster-mega-menu .sf-mega").each(function () {
          e(this).hasClass("sf-mega-full") || (e(this).css({display: "block"}), e(this).css({
            right: "",
    ...
    init_slidebar: function () {
      ...
      t.init_slidebar_pos(), e(window).load(function () {
        ...
        mouseenter: function () {
          ...
          t.slide_bar.animate({width: t.slide_bar_val.width, left: t.slide_bar_val.left}, {queue: !1, duration: 250})
        }
      ...
      if ("mobile-landscape" != t && "mobile-portrait" != t && "tablet" != t) {
        ...
        }, e.slide_bar.css({width: e.slide_bar_val.width, left: e.slide_bar_val.left, display: "block"})
      }
      ...
      if ("mobile-landscape" != t && "mobile-portrait" != t && "tablet" != t) {
        ...
        e.current_menu.length > 0 ? e.slide_bar_val = {
          ...
          width: 0,
          left: e.main_menu.children("ul").children("li:first-child").position().left
        }, e.slide_bar.animate({width: e.slide_bar_val.width, left: e.slide_bar_val.left}, {queue: !1, duration: 250})
      }
    }
    ...
    if (e(this).find('a[href="#"]').each(function () {
      ...
      e("html").addClass(s), n.offCanvas = {position: e(this).attr("data-slide")}
    }
    e(this).mmenu(n, {offCanvas: {pageNodetype: ".kingster-body-outer-wrapper"}});
  ...
  s.prototype = {
    init: function () {
      ...
      if ("mobile-landscape" != t && "mobile-portrait" != t && "tablet" != t) {
        var i = this, n = i.side_nav_content.children(".kingster-pos-middle").addClass("kingster-active"),
  ...
  a.prototype = {
    init: function () {
      ...
      t.home_anchor.on("click", function () {
        if (window.location.href == this.href) return e("html, body").animate({scrollTop: 0}, {
          duration: 1500,
          easing: "easeOutQuart"
        }), !1
      ...
      if ("#kingster-top-anchor" == i) var a = 0; else {
        var o = e(i);
        if (o.length) a = o.offset().top
      }
      return void 0 !== a ? (a -= parseInt(e("html").css("margin-top")), "mobile-portrait" == t || "mobile-landscape" == t ? a -= 75 : void 0 !== window.kingster_anchor_offset && (a -= parseInt(window.kingster_anchor_offset)), a < 0 && (a = 0), e("html, body").animate({scrollTop: a}, {
        duration: 1500,
        easing: "easeOutQuart",
        queue: !1
      }), !1) : n ? (window.location.href = kingster_script_core.home_url + i, !1) : void 0
    }, scroll_section: function () {
      var i = this, n = this.menu_anchor.find('a[href*="#"]').not('[href="#"]');
      if (n.length) {
        var s = e("#kingster-page-wrapper"), a = s.find("div[id], section[id]");
        a.length && (n.each(function () {
          0 == e(this).closest(".sub-menu").length && e(this.hash).length && e(this).attr("data-anchor", this.hash)
        }), e(window).scroll(function () {
          if ("mobile-landscape" != t && "mobile-portrait" != t && "tablet" != t) if (i.home_anchor.length && e(window).scrollTop() <= s.offset().top) i.home_anchor.each(function () {
  ...
  o.prototype = {
    init: function () {
      ...
      var i = this, n = e('<div class="kingster-sticky-menu-placeholder" ></div>');
      ...
      var i = this, n = e('<div class="kingster-sticky-mobile-placeholder" ></div>');
  ...
  r.prototype = {
    ...
    t.find(".gdlr-core-tab-item-title").on("click", function () {
      var t = e(this).attr("data-tab-id"), i = e(this).closest(".gdlr-core-tab-item-wrap");
    ...
    new r, e("#kingster-main-menu, #kingster-right-menu, #kingster-mobile-menu, #kingster-top-bar-menu").each(function () {
      ...
      var t = e(this), i = e(".kingster-header-transparent-substitute");
      ...
      n > 0 && t.css({"padding-top": n, "padding-bottom": n}), e(window).on("load resize", function () {
        t.css({
          "padding-top": 0,
          "padding-bottom": 0
    ...
    t.length && e(window).on("scroll", function () {
      ...
      var t = e(this), i = parseInt(t.attr("data-animation-time"));
    ...
    e("#kingster-fixed-footer").each(function () {
      var t = e(this), i = e('<div class="kingster-fixed-footer-placeholder" ></div>');
  ...
  e[a] && e[a].version > "5.6.1" || (e[a] = function (e, t, i) {
    ...
    init: function (e) {
      ...
      if (n.hasClass(t.vertical)) {
        ...
        var r = this.$pnls.children("." + t.panel), l = r.filter("." + t.current);
      ...
      if (this.cbck[t]) for (var i = 0, n = this.cbck[t].length; n > i; i++) this.cbck[t][i].apply(this, e)
    }, _initMenu: function () {
      ...
      var s = this, a = this.__findAddBack(n, "ul, ol");
      ...
      r.each(function (n) {
        var a, o, r = e(this), l = r.parent(), c = l.children("a, span").first();
      ...
      s.$body.on(n.click + "-oncanvas", "a[href]", function (n) {
        var s = e(this), o = !1, r = i.$menu.find(s).length;
        for (var l in e[a].addons) if (e[a].addons[l].clickAnchor.call(i, s, r)) {
          o = !0;
          break
        }
        var c = s.attr("href");
    ...
    touch: "ontouchstart" in window || navigator.msMaxTouchPoints || !1, csstransitions: function () {
      ...
      for (var n = 0; n < i.length; n++) if ("string" == typeof e[i[n] + t]) return !0;
      return !1
    }()
  })
}(jQuery), function (e) {
  var t, i, n, s, a = "mmenu", o = "offCanvas";
  e[a].addons[o] = {
    setup: function () {
      if (this.opts[o]) {
        var i = this.opts[o], n = this.conf[o];
  ...
  var t, i, n, s = "mmenu", a = "scrollBugFix";
  e[s].addons[a] = {
    setup: function () {
      var o = this, r = this.opts[a];
      if (this.conf[a], n = e[s].glbl, e[s].support.touch && this.opts.offCanvas && this.opts.offCanvas.modal && ("boolean" == typeof r && (r = {fix: r}), "object" != typeof r && (r = {}), (r = this.opts[a] = e.extend(!0, {}, e[s].defaults[a], r)).fix)) {
        ...
        this.bind("opening", function () {
          ...
          o.$pnls.children("." + t.current).scrollTop(0).css({"-webkit-overflow-scrolling": "auto"}).css({"-webkit-overflow-scrolling": "touch"})
        })
      }
    }, add: function () {
  ...
  "use strict";
  var i, n, s, a, o, r, l, c, d, h, u, p, f, m, g, v, _, k,
    b = (s = "sf-breadcrumb", a = "sf-js-enabled", o = "sf-with-ul", r = "sf-arrows", (n = /^(?![\w\W]*Windows Phone)[\w\W]*(iPhone|iPad|iPod)/i.test(navigator.userAgent)) && e("html").css("cursor", "pointer").on("click", e.noop), l = n, c = "behavior" in (i = document.documentElement.style) && "fill" in i && /iemobile/i.test(navigator.userAgent), d = !!t.PointerEvent, h = function (e, t) {
      var i = a;
      ...
      var i = e(this), n = k(i), s = i.siblings(t.data.popUpSelector);
      ...
      hide: function (t) {
        ...
        return this.each(function () {
          var t, i = e(this), n = i.data("sf-options");
        ...
        return this.each(function () {
          ...
          var n, a = e.extend({}, e.fn.superfish.defaults, t), o = i.find(a.popUpSelector).parent("li");
          a.$path = (n = a, i.find("li." + n.pathClass).slice(0, n.pathLevels).addClass(n.hoverClass + " " + s).filter(function () {
            return e(this).children(n.popUpSelector).hide().show().length
          }).removeClass(n.pathClass)), i.data("sf-options", a), h(i, a), u(o), p(i), function (t, i) {
